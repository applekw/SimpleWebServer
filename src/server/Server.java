...
public class Server implements Runnable {
	...
	// logs the given uri and the current system time. Returns true if the uri
	...
	boolean logAndCheckIfBlackListed(String uri) {
		...
		if (times.size() >= CONNECTION_NUM_INTERVAL
				&& times.get(times.size() - 1) - times.get(0) <= CONNECTION_MS_INTERVAL) {
